...
gradRates = open('Project1_Q4/p1_q4_OUT/part-r-00000')
...
if bottom10:
    ...
    fileName = 'Question4_Bottom10'
    plotTitle = 'Countries with the largest drop in male employment from the year 2000 (where data is available)'
else:
    ...
    fileName = 'Question4_Top10'
    plotTitle = 'Countries with the largest increase in male employment from the year 2000 (where data is available)'
