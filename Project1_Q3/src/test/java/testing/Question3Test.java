...
public class Question3Test {
	...
	public void testReducer() {
		...
		reduceDriver.withOutput(new Text("Change in male employment from 2000 to 2016. (%) in COUNTRYCODE: "), new DoubleWritable(10));
	...
	public void testMapReduce() {
		String s = "\"Deutschland\",\"DEU\",\"Employment to population ratio, 15+, male (%) (national estimate)\","
				+ "\"SL.EMP.TOTL.SP.MA.NE.ZS\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\","
				+ "\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\","
				+ "\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\","
				+ "\"\",\"\",\"\",\"\",\"\",\"50\",\"\",\"\",\"90\","// year 2000 = 75
		...
		mapReduceDriver.addOutput(new Text("Change in male employment from 2000 to 2015. (%) in DEU: "), new DoubleWritable(300));
